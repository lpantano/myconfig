...
call s:Enabled("g:python_highlight_all")
call s:Enabled("g:python_highlight_builtins")
...
if s:Python2Syntax()
  ...
  syn region pythonString   start=+[bB]\="+ skip=+\\\\\|\\"\|\\$+ excludenl end=+"+ end=+$+ keepend contains=pythonBytesEscape,pythonBytesEscapeError,pythonUniEscape,pythonUniEscapeError,@Spell
  syn region pythonStringDocs   start=+[bB]\="""+ end=+"""+ keepend contains=pythonBytesEscape,pythonBytesEscapeError,pythonUniEscape,pythonUniEscapeError,pythonDocTest2,pythonSpaceError,@Spell
  syn region pythonStringDocs   start=+[bB]\='''+ end=+'''+ keepend contains=pythonBytesEscape,pythonBytesEscapeError,pythonUniEscape,pythonUniEscapeError,pythonDocTest,pythonSpaceError,@Spell
else
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonFunctionAlone    FunctionAlone
  HiLink pythonClassCall	FunctionAlone
  ...
  HiLink pythonStringDocs       Comment
  ...
  HiLink pythonBuiltinFunc      BFunction
